...
c                                                                       p7500150
      open(unit=5,file='ber907505_5.dat',status='old')
...
c                                                                       p7502580
 ...
 6505 format(1x,i4,4x,f8.2,4x,f10.6,4x,f10.4,4x,f10.0)                  p7502880
      write(7,7000) i,baf(i),s(i),d11(i),ac                             p7502890
 7000 format(i5,2x,f13.7,2x,f10.6,2x,f10.4,2x,f10.0)                    p7502900
  ...
  552 write(6,6505) i,paf(i),ss(i),d111(i),ac                           p7503150
      write(7,7000) i,paf(i),ss(i),d111(i),ac                           p7503160
      m=m+1                                                             p7503170
      mn=mn+1                                                           p7503180
